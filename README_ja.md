...
> **バージョン注記**：中国語版は現在の 2026 Springer 出版主線で、14 部、48 章、15 件のプロジェクトケーススタディ、3 つの付録に固定されています。英語版と日本語版は部分翻訳および対外紹介用ビューとして更新中で、ドキュメントサイトには翻訳状況ページを用意しています。
...
```
📖 全14部、48章 + 15件のプロジェクトケーススタディ + 3つの付録
│
├── 第1部：総論とインフラ（第1-3章）
